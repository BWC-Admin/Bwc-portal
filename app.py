...
sc_req, sc_paid, sc_count = get_group_stats("Second Chance")

# 3. Keep these for global system overview if needed
total_req_levy = adom_req + sc_req
total_paid_ledger = adom_paid + sc_paid
conn.close()
